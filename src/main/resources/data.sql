...
insert into korisnik(datum_rodjenja,ime,korisnicko_ime,lozinka,mail_adresa,opis,prezime,profilna_slika) values('1999-1-1','Dusan','DusanM','pass1234','email@gmail.com','pisac','mutuc','foto');
...
insert into korisnik(datum_rodjenja,ime,korisnicko_ime,lozinka,mail_adresa,opis,prezime,profilna_slika) values('2012-12-12','Kraj','Svetic','Gotovo','finalniDan@gmail.com','ende','sveta','foto');
insert into polica (naziv,primarna,korisnikID) values('Want to Read',true,1);
insert into polica(naziv, primarna,korisnikID) values('Currently Reading',true,1);
insert into polica(naziv, primarna,korisnikID) values('Read',true,1);
